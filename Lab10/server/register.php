...
<body>
    ...
    $file = fopen("../database/database.txt","r");
        ...
        if($exist == 1){
            echo "The user is already exist! <br/><br/>Go <a href='http://titan.csit.rmit.edu.au/~s3711351/Lab10/client/'>back</a> to register, login or check the users.txt";
        }else{
        ...
        //close the "$file"
            fclose($file);
            echo "The user is added to the database.txt. <br/><br/>Go <a href='http://titan.csit.rmit.edu.au/~s3711351/Lab10/client/'>back</a> to register, login or check the users.txt";
        }
    ?>
</body>
