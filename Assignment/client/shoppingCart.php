...
<head>
    ...
    <script type="text/javascript" src="js/shoppingCartController.js"></script>
...
<body>
    ...
    <FORM ACTION="../server/shoppingCart.php" method="POST">
        <table width="100%" onchange="update()">
            ...
            <tr>
                <td width="29%"><input type="hidden" id="aname" name="aname" value="producta">Product A</td>
                <td width="17%"><input type="hidden" id="aprice" name="aprice" value="10">$10</td>
                <td width="30%"><input min="0" type="number" id="aquantity" name="aquantity" style="width:30px"
                        value="0"></td>
                <td>
                    <p id="atotal"> 0</p>
            ...
            <tr>
                <td></td>
                <td><button type="button" id="update" onClick="update()">Update</button></td>
                <td></td>
